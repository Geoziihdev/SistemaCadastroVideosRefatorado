...
public class VideoDAO {
    ...
    public void cadastrarVideo(Video video) {
        if (video.getCategoria() == null || video.getCategoria().getIdCategoria() <= 0) {
            throw new RuntimeException("Categoria inválida. Cadastre uma categoria primeiro.");
        }
        ...
        try (Connection conn = Conexao.getConnection();
            ...
            if (linhas > 0) {
                ...
                throw new RuntimeException("Erro ao cadastrar vídeo: nenhuma linha afetada.");
            }

        } catch (SQLException e) {
            throw new RuntimeException("Erro ao cadastrar vídeo: " + e.getMessage());
        }
    }
    ...
    public List<Video> listarVideos() {
        ...
        try (Connection conn = Conexao.getConnection();
            ...
            throw new RuntimeException("Erro ao listar vídeos: " + e.getMessage());
        }
